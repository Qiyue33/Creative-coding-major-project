...
Finally, I created audio shapes for the graphics, such as circles, triangles, and halos, modifying their coordinates in combination with RMS elements to achieve the desired visual effects.